...
<style scoped>
.live2d-panel { display:flex; min-width:0; flex-direction:column; padding:22px 16px 14px; border-left:1px solid var(--line); background:linear-gradient(160deg,var(--surface) 0%,var(--brand-soft) 210%); }.live2d-head { display:flex; align-items:center; justify-content:space-between; gap:8px; padding:0 3px 15px; border-bottom:1px solid var(--line); }.eyebrow { color:var(--muted); font:600 10px/1.2 ui-monospace,monospace; letter-spacing:.1em; }.live2d-head strong { display:block; margin-top:4px; font-size:16px; }.live2d-head select { max-width:138px; border:1px solid var(--line); border-radius:8px; padding:7px; color:var(--text); background:var(--surface); font-size:11px; }.live2d-stage { position:relative; min-height:0; flex:1; margin-top:14px; overflow:hidden; border:1px solid color-mix(in srgb, var(--line) 75%, transparent); border-radius:18px; background:radial-gradient(circle at 50% 25%, color-mix(in srgb, var(--surface) 92%, transparent), transparent 60%); touch-action:none; }.live2d-stage :deep(canvas) { display:block; width:100%; height:100%; cursor:grab; }.live2d-stage :deep(canvas):active { cursor:grabbing; }.live2d-panel > p { margin:9px 5px 0; color:var(--muted); text-align:center; font-size:11px; }
</style>
